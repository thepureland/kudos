 ...
 * @property requireRpcMarker Whether to additionally require the internal Feign marker header
 *   ([io.kudos.context.support.Consts.RequestHeader.RPC_REQUEST]) before a request may take part in cache
 *   negotiation.
 *
 ...
 *   `kudos-ability-distributed-client-http` — a module this one depends on only at compile/test time, so its
...
class InterServiceCacheProviderProperties {
    ...
    var requireRpcMarker: Boolean = false
}
