...
import io.kudos.ability.log.audit.commobn.entity.SysAuditDetailLogVo
import io.kudos.ability.log.audit.commobn.entity.SysAuditLogModel
import io.kudos.ability.log.audit.commobn.entity.SysAuditLogVo
...
//        val logVo  = LogVo()
//        val baseLog = logVo.addAuditLog(audit)
//        if (audit.ignoreForm() === YesNotEnum.NOT) {
//            val body = getRequestData(request)
//            KudosContextHolder.get().clientInfo.
//            CommonContext.get().getClientInfo().setRequestData(body)
//        }
//        val entityId: String? = request.getParameter("id")
//        if (StringTool.isNotBlank(entityId)) {
...
//        val wrapper: HttpServletRequestWrapper = request as HttpServletRequestWrapper
...
//        } else if (wrapper.getRequest() is ContentCachingRequestWrapper) {
//            contentCachingRequestWrapper = wrapper.getRequest() as ContentCachingRequestWrapper?
//        }
//        if (contentCachingRequestWrapper != null) {
//            val contentAsByteArray: ByteArray = contentCachingRequestWrapper.getContentAsByteArray()
    ...
    fun createSysAuditLogModel(logVo: LogVo, argString: String): SysAuditLogModel? {
        ...
        if (!vos.isNullOrEmpty()) {
            ...
            for (vo in vos) {
                ...
                if (vo.ignoreForm === YesNotEnum.YES.getBool()) {
