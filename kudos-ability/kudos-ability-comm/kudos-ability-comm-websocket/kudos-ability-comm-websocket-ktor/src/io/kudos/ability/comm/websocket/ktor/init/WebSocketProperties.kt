...
data class WebSocketProperties(
     ...
     * See [io.kudos.ability.comm.websocket.ktor.broadcast.WebSocketBroadcaster] for the rationale.
     *
     ...
     *
     * @property enabled turn on the Redis-backed [io.kudos.ability.comm.websocket.ktor.distributed.DistributedWebSocketBroadcaster]
