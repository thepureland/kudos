...
internal class WebSocketHandlerDecoratorTest {
    ...
    @Test
    fun baseClass_delegatesEveryHookUnchanged() = runBlocking {
    ...
    @Test
    fun wrappedBy_appliesFactoriesOutermostFirst() = runBlocking {
    ...
    @Test
    fun decorator_canShortCircuitTheDelegate() = runBlocking {
        val terminal = RecordingHandler("t")
