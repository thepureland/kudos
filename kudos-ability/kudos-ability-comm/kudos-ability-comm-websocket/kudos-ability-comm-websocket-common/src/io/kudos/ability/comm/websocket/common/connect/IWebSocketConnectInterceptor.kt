...
fun interface IWebSocketConnectInterceptor {
     ...
     * [io.kudos.ability.comm.websocket.common.session.KudosWebSocketSession] and reads `raw.call` —
...
sealed interface WebSocketConnectDecision {
     ...
     */
    data class Reject(val reason: WebSocketCloseReason) : WebSocketConnectDecision {

        constructor(code: WebSocketCloseReason.Codes, message: String) : this(WebSocketCloseReason(code, message))
    }
}
