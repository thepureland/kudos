 ...
 *
 * Dual of the client-side `IHttpRequestContextProcess` (in the `kudos-ability-distributed-client-http`
 ...
 *
 * Application code just registers the implementation as a Spring bean — [io.kudos.ability.distributed.discovery.nacos.filter.InternalRpcContextWebFilter]
 * will discover and invoke every implementation automatically.
 *
 * @author K
 * @since 1.0.0
 */
interface IRpcProviderContextProcess {
    /**
