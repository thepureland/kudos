 ...
 * `KudosContextRequestInterceptor` (module `kudos-ability-distributed-client-http`).
 *
 ...
 *
 * Header names are mirrored from `HttpContextSignature` in the client module — the two modules
 ...
 * @since 1.0.0
 */
class InternalRpcContextSignatureVerifier(
    secret: String,
    ...
    companion object {
        /** Must stay in sync with `HttpContextSignature.TIMESTAMP_HEADER` in kudos-ability-distributed-client-http. */
        const val TIMESTAMP_HEADER: String = "X-Kudos-Context-Timestamp"

        /** Must stay in sync with `HttpContextSignature.NONCE_HEADER` in kudos-ability-distributed-client-http. */
        const val NONCE_HEADER: String = "X-Kudos-Context-Nonce"

        /** Must stay in sync with `HttpContextSignature.SIGNATURE_HEADER` in kudos-ability-distributed-client-http. */
