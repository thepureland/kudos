...
/**
 * Writable data access interface.
 *
 * Defines write operations of the data access layer, including insert, update, and delete.
 * Extends IBaseReadOnlyDao, adding data modification capabilities on top of read-only operations.
 *
 * Core features:
 * 1. Insert operations: support single and batch inserts; support inserting specified or excluded properties
 * 2. Update operations: support single and batch updates; support conditional updates and updating specified properties
 * 3. Delete operations: support deleting by primary key, by condition, and in batch
 *
 * Insert operations:
 ...
 *
 * Use cases:
 * - Data access layer of an ORM framework
 * - Data modification operations at the business layer
...
interface IBaseCrudDao<PK : Any, E : IIdEntity<PK>> : IBaseReadOnlyDao<PK, E> {
     ...
     *
     * @param entity Entity object (only changed properties are updated)
