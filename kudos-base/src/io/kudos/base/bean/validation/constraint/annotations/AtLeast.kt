...
/**
 * "At least N" constraint annotation, a class-level annotation that validates that at least N of the specified properties satisfy the given assertion logic.
 *
 * @author K
 * @since 1.0.0
 */
...
annotation class AtLeast(
    /**
     * Names of the properties to validate.
     */
    val properties: Array<String>,
    /**
     * Assertion logic; the default checks whether the value is not null.
     */
    val logic: AssertLogicEnum = AssertLogicEnum.IS_NOT_NULL,
    /**
     * The minimum number of properties whose value must satisfy the given assertion logic.
     */
    val count: Int = 1,
    /**
