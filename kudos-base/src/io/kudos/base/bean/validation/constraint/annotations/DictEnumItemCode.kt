...
/**
 * Dictionary enum code constraint annotation, a property-level annotation. Used to validate whether a string is the dictionary item code of one of the enums in the specified dictionary enum class.
 *
 * @author K
 * @since 1.0.0
 */
...
annotation class DictEnumItemCode(
    /**
     * Dictionary enum class.
     */
     ...
     */
    val message: String = "sys.valid-msg.default.DictEnumCode",
    /**
