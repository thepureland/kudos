...
/**
 * Apply the Constraints constraint to every element of an Array, Collection, or Map; validation passes as long as any one element passes the Constraints constraint. The counterpart of the Each constraint.
...
annotation class Exist(
     ...
     */
    val message: String = "io.kudos.base.bean.validation.constraint.annotations.Any.message",
    /**
