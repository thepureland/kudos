...
/**
 * Custom constraint annotation. The user can implement the validation logic; this is a property-level annotation. The validated object may be of any type.
 *
 * @author K
 * @since 1.0.0
 */
...
annotation class Custom(
    /**
     * The class that performs the validation logic.
     */
