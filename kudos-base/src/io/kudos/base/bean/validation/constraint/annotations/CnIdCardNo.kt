...
/**
 * Chinese (currently only mainland is supported) ID card number constraint annotation.
 *
 * @author K
 * @since 1.0.0
 */
...
annotation class CnIdCardNo(
    /**
     * Whether to support the 15-digit mainland ID card; false means only 18-digit is supported.
     */
     ...
     */
    val message: String = "sys.valid-msg.default.CnIdCardNo",
    /**
