...
import io.kudos.base.bean.validation.constraint.validator.DateTimeValidator
import jakarta.validation.Constraint
import jakarta.validation.Payload
import kotlin.reflect.KClass

/**
 * Date/time constraint annotation, a property-level annotation. Validates whether the given string is a date/time in the specified format.
 *
 * @author K
 * @since 1.0.0
 */
...
annotation class DateTime(
     ...
     */
    val message: String = "sys.valid-msg.default.DateTime",
    /**
