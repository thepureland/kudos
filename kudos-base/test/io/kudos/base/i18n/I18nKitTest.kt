...
internal class I18nKitTest {
    ...
    fun getI18nMap() {
        ...
        assertEquals("中文簡體", i18nMap["test"]!!["kudos-base-test"]!!["language.zh_CN"])

        // 默认Locale
        i18nMap = I18nKit.getI18nMap()
        assertEquals("中文简体", i18nMap["test"]!!["kudos-base-test"]!!["language.zh_CN"])
    ...
    @Test
    fun getLocalStr() {
        assertEquals("中文簡體", I18nKit.getLocalStr("language.zh_CN", "kudos-base-test", "test", "zh_TW"))

        // 默认Locale
        assertEquals("中文简体", I18nKit.getLocalStr("language.zh_CN", "kudos-base-test", "test"))

        // 找不到的情况
        assertEquals("xxx", I18nKit.getLocalStr("xxx", "kudos-base-test", "test", "zh_TW"))
        ...
        // 不支持的Locale，按默认Locale处理
        assertEquals("中文简体", I18nKit.getLocalStr("language.zh_CN", "kudos-base-test", "test", "zh_cn"))
    }
    ...
    fun initI18n() {
        ...
        assertEquals("中文简体", I18nKit.getLocalStr("language.zh_CN", "kudos-base-test", "test", "zh_TW"))

        // 重新初始化
        I18nKit.initI18n(setOf("zh_CN", "zh_TW", "en_US"), setOf("test"), "en_US")
        assertEquals("Simplified Chinese", I18nKit.getLocalStr("language.zh_CN", "kudos-base-test", "test"))
    }
