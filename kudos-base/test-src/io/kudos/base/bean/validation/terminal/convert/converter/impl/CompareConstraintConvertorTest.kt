...
internal class CompareConstraintConvertorTest {
    ...
    fun test() {
        ...
        val terminalConstraint = CompareConstraintConvertor(annotation).convert(context)
        println(terminalConstraint)
        ...
        val terminalConstraint1 = CompareConstraintConvertor(annotation1).convert(context1)
        println(terminalConstraint1)
