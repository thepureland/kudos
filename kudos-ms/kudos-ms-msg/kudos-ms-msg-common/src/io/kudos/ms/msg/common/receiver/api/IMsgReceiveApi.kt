...
interface IMsgReceiveApi {
     ...
     */
    @GetExchange("/api/internal/msg/receive/getReceivesByUserId")
     ...
     */
    @GetExchange("/api/internal/msg/receive/getUnreadCountByUserId")
     ...
     */
    @PostExchange("/api/internal/msg/receive/markRead")
     ...
     */
    @PostExchange("/api/internal/msg/receive/markAllReadByUserId")
