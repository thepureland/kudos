...
-- dict
insert ignore into `sys_i18n` (`id`, `locale`, `atomic_service_code`, `i18n_type_dict_code`, `namespace`, `key`, `value`, `built_in`) values
    ('bba0ce4a-35c0-4497-8a24-27d976adf6f2', 'zh_CN', 'kudos-msg', 'dict', 'dict', 'publish_method', '发布方式', true),
    ('2f8c652e-b9e4-4ff2-8845-c66463f44979', 'zh_TW', 'kudos-msg', 'dict', 'dict', 'publish_method', '發布方式', true),
    ('064dc55c-00f2-445a-bd2d-3488a9115613', 'en_US', 'kudos-msg', 'dict', 'dict', 'publish_method', 'Publish Method', true),

    ('e0675547-77b3-4a17-8143-373b8baf3095', 'zh_CN', 'kudos-msg', 'dict', 'dict', 'receiver_group_type', '接收者群组类型', true),
    ('3af2c6f2-16c4-4a26-9a20-7402eedce2cd', 'zh_TW', 'kudos-msg', 'dict', 'dict', 'receiver_group_type', '接收者群組類型', true),
    ('3a308a2f-f506-445a-a1fe-27f7108f3d25', 'en_US', 'kudos-msg', 'dict', 'dict', 'receiver_group_type', 'Receiver Group Type', true),

    ('22a5cd88-3437-45d0-b900-8f8673f666b4', 'zh_CN', 'kudos-msg', 'dict', 'dict', 'send_status', '发送状态', true),
    ('2460a2b1-03d2-4ad9-adff-3fab7bb1890f', 'zh_TW', 'kudos-msg', 'dict', 'dict', 'send_status', '發送狀態', true),
    ('f7557a6d-918d-4ee9-aa90-06429661f31e', 'en_US', 'kudos-msg', 'dict', 'dict', 'send_status', 'Send Status', true),

    ('9c5635f3-d63f-4aa2-a8b8-25f460781355', 'zh_CN', 'kudos-msg', 'dict', 'dict', 'tmpl_type', '模板类型', true),
    ('ad511c76-d567-470d-a35c-defe597e4066', 'zh_TW', 'kudos-msg', 'dict', 'dict', 'tmpl_type', '模板類型', true),
    ('f987a54d-9c7b-45eb-a2bc-d6beec88850c', 'en_US', 'kudos-msg', 'dict', 'dict', 'tmpl_type', 'Template Type', true),

    ('a173e264-b19a-4cbf-b47b-75bcc7ac2c69', 'zh_CN', 'kudos-msg', 'dict', 'dict', 'auto_event_type', '系统通知模板事件类型', true),
    ('d8ea0b62-9fe1-4b75-9f99-38df9f697c16', 'zh_TW', 'kudos-msg', 'dict', 'dict', 'auto_event_type', '系統通知模板事件類型', true),
    ('a54d8c55-3910-49de-9019-12f8f5e49921', 'en_US', 'kudos-msg', 'dict', 'dict', 'auto_event_type', 'System Notification Template Event Type', true),

    ('343e6f58-1cdf-4939-b475-b30e7cd615ee', 'zh_CN', 'kudos-msg', 'dict', 'dict', 'manual_event_type', '手动通知模板事件类型', true),
    ('6bd8c248-fdfd-4519-ba9d-389eac7d883b', 'zh_TW', 'kudos-msg', 'dict', 'dict', 'manual_event_type', '手動通知模板事件類型', true),
    ('3bf20c4b-9d26-4a78-8b17-4675b596b2d5', 'en_US', 'kudos-msg', 'dict', 'dict', 'manual_event_type', 'Manual Notification Template Event Type', true),

    ('fbe5d998-5aed-439e-9f8d-4ef210ea6f4c', 'zh_CN', 'kudos-msg', 'dict', 'dict', 'params', '通知参数', true),
    ('e0fc86b4-2a99-43eb-b002-261e9131b655', 'zh_TW', 'kudos-msg', 'dict', 'dict', 'params', '通知參數', true),
    ('5a8364b3-6e38-493c-a923-8eca5a6000ac', 'en_US', 'kudos-msg', 'dict', 'dict', 'params', 'Notification Parameters', true),

    ('8f8c4384-0ccd-4548-b4d0-7c744d47d415', 'zh_CN', 'kudos-msg', 'dict', 'dict', 'receive_status', '接收状态', true),
    ('c99b7c00-3339-4f98-987b-7fb3af4a2800', 'zh_TW', 'kudos-msg', 'dict', 'dict', 'receive_status', '接收狀態', true),
