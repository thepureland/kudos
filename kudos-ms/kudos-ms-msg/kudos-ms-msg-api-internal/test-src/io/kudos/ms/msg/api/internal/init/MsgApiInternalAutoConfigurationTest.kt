...
/**
 * test for MsgApiInternalAutoConfiguration (pure instantiation, no Spring container)
 *
 * Coverage:
 ...
 * @since 1.0.0
 */
internal class MsgApiInternalAutoConfigurationTest {

    @Test
    fun getComponentName_returnsModuleName() {
        val config = MsgApiInternalAutoConfiguration()
    ...
    fun getComponentName_viaInterfaceContract() {
        val initializer: IComponentInitializer = MsgApiInternalAutoConfiguration()
