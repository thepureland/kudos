...
(
    ...
    "security_password_error_times" integer,
...
comment on table "user_account" is '用户基本信息';
...
comment on column "user_account"."last_login_time" is '最后登录时间';
comment on column "user_account"."last_login_ip" is '最后登录IP';
comment on column "user_account"."last_logout_time" is '最后登出时间';
comment on column "user_account"."login_error_times" is '登录错误次数';
comment on column "user_account"."security_password_error_times" is '安全密码错误次数';
comment on column "user_account"."session_key" is '会话密钥';
comment on column "user_account"."authentication_key" is '认证密钥';
comment on column "user_account"."org_id" is '所属机构ID';
comment on column "user_account"."supervisor_id" is '直属上级ID';
comment on column "user_account"."remark" is '备注';
comment on column "user_account"."active" is '是否激活';
