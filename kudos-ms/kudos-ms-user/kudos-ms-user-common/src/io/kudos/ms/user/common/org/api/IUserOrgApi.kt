...
interface IUserOrgApi {
    ...
    @GetExchange("/api/internal/user/org/getOrgById")
    fun getOrgById(@RequestParam id: String): UserOrgCacheEntry?

    /** Batch fetch org cache entries */
    @PostExchange("/api/internal/user/org/getOrgsByIds")
    ...
    @GetExchange("/api/internal/user/org/getParentOrg")
