-- user_org: 每条 id 唯一，使用 user-org-dao-test-* 前缀隔离
merge into "user_org" ("id", "name", "tenant_id", "org_type_dict_code", "sort_num", "remark", "active", "built_in", "create_user_id", "create_user_name") values
    ('669d8a45-0000-0000-0000-000000000010', 'user-org-dao-test-1-w2nwgBMU', 'user-tenant-dao-test-1-w2nwgBMU', 'ORG_TYPE_TEST', 1, 'from UserOrgDaoTest', true, false, 'system', '系统'),
