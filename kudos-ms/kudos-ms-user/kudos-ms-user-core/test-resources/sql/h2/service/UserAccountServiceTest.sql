-- user_account: 每条 id 唯一，使用 svc-user-test-* 前缀隔离
merge into "user_account" ("id", "username", "tenant_id", "login_password", "supervisor_id", "org_id", "remark", "active", "built_in", "create_user_id", "create_user_name") values
    ('a970f8c0-0000-0000-0000-000000000016', 'svc-user-test-1-3iZR7Pv6', 'svc-tenant-user-test-1-3iZR7Pv6', 'encrypted-pwd-1-3iZR7Pv6', '00000000-0000-0000-0000-000000000000', 'a970f8c0-0000-0000-0000-000000000020', 'from UserAccountServiceTest', true, false, 'system', '系统'),
...
-- user_org: 供 getUsersByOrgId 等用例使用
merge into "user_org" ("id", "name", "tenant_id", "org_type_dict_code", "sort_num", "remark", "active", "built_in", "create_user_id", "create_user_name") values
    ('a970f8c0-0000-0000-0000-000000000020', 'svc-org-user-test-1-3iZR7Pv6', 'svc-tenant-user-test-1-3iZR7Pv6', 'ORG_TYPE_TEST', 1, 'from UserAccountServiceTest', true, false, 'system', '系统'),
