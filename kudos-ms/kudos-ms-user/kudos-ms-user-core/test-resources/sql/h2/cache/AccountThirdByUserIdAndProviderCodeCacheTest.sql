...
merge into "user_account" ("id", "username", "tenant_id", "login_password", "display_name", "supervisor_id", "remark", "active", "built_in") values
    ('9a1a0000-0000-0000-0000-000000000001', 'third_user1', 'tenant-third-1', 'password', '第三方用户1', '00000000-0000-0000-0000-000000000000', '测试用户1', true, false),
...
-- user_account_third: 每条 id 唯一，(user_id, account_provider_dict_code) 供缓存 key 使用
merge into "user_account_third" ("id", "user_id", "account_provider_dict_code", "account_provider_issuer", "subject", "union_id", "external_display_name", "external_email", "avatar_url", "last_login_time", "tenant_id", "remark", "active", "built_in") values
    ('9b1a0000-0000-0000-0000-000000000001', '9a1a0000-0000-0000-0000-000000000001', 'WX', null, 'sub-1', 'union-1', 'wx-user1', 'wx1@example.com', null, null, 'tenant-third-1', 'wx', true, false),
