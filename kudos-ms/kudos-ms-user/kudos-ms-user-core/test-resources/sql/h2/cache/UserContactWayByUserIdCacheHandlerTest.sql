-- 测试数据 for UserContactWayByUserIdCacheHandler

merge into "user_account" ("id", "username", "tenant_id", "login_password", "display_name", "supervisor_id", "remark", "active", "built_in")
    values ('7a1a0000-0000-0000-0000-000000000001', 'contact_user1', 'tenant-contact-1', 'password', '联系用户1', '00000000-0000-0000-0000-000000000000', '测试用户1', true, false),
...
merge into "user_contact_way" ("id", "user_id", "contact_way_dict_code", "contact_way_value", "contact_way_status_dict_code", "priority", "remark", "active", "built_in")
    values ('8b1a0000-0000-0000-0000-000000000001', '7a1a0000-0000-0000-0000-000000000001', '01', '13300000001', '00', 1, '主手机号', true, false),
