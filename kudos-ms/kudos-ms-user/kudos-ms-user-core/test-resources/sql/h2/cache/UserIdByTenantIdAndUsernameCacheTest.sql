-- user_account: 每条 id 唯一，(tenant_id, username) 供缓存 key 使用
merge into "user_account" ("id", "username", "tenant_id", "login_password", "display_name", "supervisor_id", "remark", "active", "built_in", "create_user_id", "create_user_name", "update_user_id", "update_user_name") values
    ('29e1c4c0-1111-1111-1111-111111111111', 'admin', 'tenant-001-d4JfsZwG', 'password123-d4JfsZwG', '管理员', '00000000-0000-0000-0000-000000000000', '系统管理员', true, true, 'system', '系统', null, null),
