 ...
 *
 * 测试数据来源：`UserIdByTenantIdAndUsernameCacheTest.sql`
 *
 * @author K
 * @author AI: Cursor
 * @since 1.0.0
...
class UserIdByTenantIdAndUsernameCacheTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: UserIdByTenantIdAndUsernameCache
