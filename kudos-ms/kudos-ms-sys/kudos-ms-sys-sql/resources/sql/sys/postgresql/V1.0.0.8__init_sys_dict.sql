...
insert into "sys_dict" ("id", "atomic_service_code", "dict_type", "dict_name", "remark", "built_in") values
    ('68139ed2-dbce-47fa-ac0d-2932fb0ee5ad', 'sys', 'ds_use', 'ds_use', null, false),
    ('d9f17338-8751-4d3b-bdd1-91a1b6f42432', 'sys', 'ds_type', 'ds_type', '暂时只支持一种数据源类型hikariCP', false),
    ('339b4cf1-6af4-49db-be1c-ee606959a689', 'sys', 'resource_type', 'resource_type', null, false),
    ('2601c57f-3900-4be8-9ebf-e79781db9d3d', 'sys', 'cache_strategy', 'cache_strategy', null, false),
    ('54094f46-dddb-41a2-b747-0eaa7d0e59b6', 'sys', 'locale', 'locale', 'locale', true),
    ('54094f46-dddb-41a2-b747-0eaa7d0ekil6', 'sys', 'i18n_type', 'i18n_type', null, true),
    ...
    on conflict ("dict_type", "atomic_service_code") do nothing;
