 ...
 *
 * 测试数据来源：`TenantIdsBySystemCodeCacheTest.sql`
 *
 * @author K
 * @since 1.0.0
 */
@EnabledIfDockerInstalled
class TenantIdsBySystemCodeCacheTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: TenantIdsBySystemCodeCache
