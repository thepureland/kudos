 ...
 *
 * 测试数据来源：`MicroServiceByCodeCacheTest.sql`
 *
 * @author K
 * @since 1.0.0
 */
@EnabledIfDockerInstalled
class MicroServiceByCodeCacheTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: MicroServiceByCodeCache
