 ...
 *
 * 测试数据来源：`DataSourceByTenantIdAnd3CodesCacheTest.sql`
 *
 * @author K
 * @since 1.0.0
 */
@EnabledIfDockerInstalled
class DataSourceByTenantIdAnd3CodesCacheTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: DataSourceByTenantIdAnd3CodesCache
    ...
    fun syncOnUpdateActive() {
        ...
        assert(success)
        val ds2 = dataSourceByIdCache.getDataSourceById(id2)!!
        ...
        assert(success)
        val ds0 = dataSourceByIdCache.getDataSourceById(id0)!!
