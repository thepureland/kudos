...
class SysSubSystemMicroServiceDaoTest : RdbTestBase() {
    ...
    fun searchMicroServiceCodesBySubSystemCode() {
        ...
        assertTrue(codes.contains("svc-ms-subsysms-dao-test-1"))
        assertTrue(codes.contains("svc-ms-subsysms-dao-test-2"))
    }

    @Test
    fun searchSubSystemCodesByMicroServiceCode() {
        val microServiceCode = "svc-ms-subsysms-dao-test-1"
        ...
        assertTrue(codes.contains("svc-subsys-subsysms-dao-test-2"))
    }

    @Test
    fun exists() {
        // 测试存在的关系
        assertTrue(sysSubSystemMicroServiceDao.exists("svc-subsys-subsysms-dao-test-1", "svc-ms-subsysms-dao-test-1"))
