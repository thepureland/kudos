 ...
 */
@Component
open class SubSystemByCodeCache : AbstractByIdCacheHandler<String, SysSystemCacheItem, SysSystemDao>() {
    ...
    override fun doReload(key: String): SysSystemCacheItem? {
        return getSelf<SubSystemByCodeCache>().getSubSystemByCode(key)
    }
