 ...
 */
@Component
open class MicroServiceByCodeCache : AbstractByIdCacheHandler<String, SysMicroServiceCacheItem, SysMicroServiceDao>() {
    ...
    override fun doReload(key: String): SysMicroServiceCacheItem? {
        return getSelf<MicroServiceByCodeCache>().getMicroServiceByCode(key)
    }
