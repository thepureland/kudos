...
insert into "sys_i18n" ("locale", "atomic_service_code", "i18n_type_dict_code", "namespace", "key", "value", "built_in") values
    ...
    ('zh-CN', 'sys', 'view', 'menu', 'sys', '系统', true),
    ('zh-TW', 'sys', 'view', 'menu', 'sys', '系統', true),
    ('en-US', 'sys', 'view', 'menu', 'sys', 'System', true),

    ('zh-CN', 'sys', 'view', 'menu', 'subSys', '子系统', true),
    ('zh-TW', 'sys', 'view', 'menu', 'subSys', '子系統', true),
    ('en-US', 'sys', 'view', 'menu', 'subSys', 'Subsystem', true),
