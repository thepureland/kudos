...
merge into "sys_system" ("code", "name", "parent_code", "sub_system", "remark", "active", "built_in")
    values ('svc-subsys-domain-test-1', 'svc-subsys-domain-test-1-name', 'svc-system-domain-test-1', true, 'from SysDomainServiceTest', true, false);

merge into "sys_domain" ("id", "domain", "system_code", "tenant_id", "remark", "active", "built_in")
    values ('20000000-0000-0000-0000-000000000032', 'svc-domain-test-1.com', 'svc-system-domain-test-1', '20000000-0000-0000-0000-000000000032', 'from SysDomainServiceTest', true, false);
