-- 测试数据：SysI18nHashCache
-- 复用 sys_i18n 数据，与 I18NByLocaleAndTypeAndMsCodeCacheTest 共用同一批 micro_service
...
merge into "sys_i18n" ("id", "locale", "atomic_service_code", "i18n_type_dict_code", "namespace", "key", "value", "active", "built_in") values
    ...
    ('40000000-0000-0000-0000-000000008915', 'zh_CN', 'as-i18n-test-1_8910', 'label', 'msg.key', '1', 'msg-value-1', true, false),
