...
/**
 * Unit tests for [HttpDictItemCodeFinder].
 *
 * Coverage:
 ...
 * @since 1.0.0
 */
internal class HttpDictItemCodeFinderTest {

    /** Lightweight fake proxy recording invocations; no HTTP involved. */
    ...
    fun getDictItemCodes_mapsItemCodesToSet_andPassesParamsInOrder() {
        ...
        val codes = HttpDictItemCodeFinder().getDictItemCodes("kudos-sys", "sex")
    ...
    fun getDictItemCodes_emptyProxyResult_yieldsEmptySet() {
        ...
        assertTrue(HttpDictItemCodeFinder().getDictItemCodes("kudos-sys", "unknown").isEmpty())
    }
    ...
    fun getDictItemCodes_fetchesProxyBeanOnlyOnce_thenCachesIt() {
        ...
        val finder = HttpDictItemCodeFinder()
    ...
    fun getDictItemCodes_withoutSpringContext_failsWithNotInitializedError() {
        ...
        val ex = assertFailsWith<IllegalStateException> {
            HttpDictItemCodeFinder().getDictItemCodes("kudos-sys", "sex")
        }
