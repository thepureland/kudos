...
/**
 * Dictionary item code finder (interface-client implementation).
 *
 * Serves downstream microservices that **do not deploy sys-core**: when their VOs carry `@DictItemCode` validation, active dictionary codes are fetched remotely via the sys interface client.
 *
 ...
 * @since 1.0.0
 */
class HttpDictItemCodeFinder : IDictItemCodeFinder {
