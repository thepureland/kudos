...
/**
 * test for SysApiInternalAutoConfiguration (pure instantiation, no Spring container)
 *
 * Coverage:
 ...
 * @since 1.0.0
 */
internal class SysApiInternalAutoConfigurationTest {

    @Test
    fun getComponentName_returnsModuleName() {
        val config = SysApiInternalAutoConfiguration()
    ...
    fun getComponentName_viaInterfaceContract() {
        val initializer: IComponentInitializer = SysApiInternalAutoConfiguration()
