...
create table tag_membership (
    ...
    rule_version bigint,
    effective_from timestamp(6), effective_until timestamp(6),
    membership_version bigint not null,
    source_event_id char(36), update_time timestamp(6) not null,
...
create table tag_assignment (
    ...
    effective_from timestamp(6), effective_until timestamp(6), update_time timestamp(6) not null,
...
create table tag_manual_assignment_event (
    ...
    constraint ck_tag_manual_event_operation check (operation in ('ASSIGN', 'REMOVE')),
    constraint ck_tag_manual_event_status check (process_status in ('RECEIVED', 'APPLIED'))
);
...
create table tag_recalculation_job (
    ...
    lease_owner varchar(128), lease_until timestamp(6),
    processed_count bigint not null,
    last_error_code varchar(64), last_error_message varchar(1000),
    create_time timestamp(6) not null, start_time timestamp(6), complete_time timestamp(6), update_time timestamp(6) not null,
