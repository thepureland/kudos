...
internal class RuntimePersistenceMappingTest {
    ...
    fun runtimeTablesMapEverySchemaColumnAndNaturalPrimaryKey() {
        ...
        assertMapping(TagManualAssignmentEvents, "event_id,payload_checksum,request_id,tenant_id,subject_type,subject_id,tag_id,operation,manual_source_ref,operator_id,operator_name,reason,effective_until,occurred_time,received_time,process_status", "event_id")
