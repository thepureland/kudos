 ...
 *
 * 测试数据来源：`UserIdsByGroupIdCacheHandlerTest.sql`
 *
 * @author K
 * @author AI: Codex
 * @since 1.0.0
...
class UserIdsByGroupIdCacheHandlerTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: UserIdsByGroupIdCacheHandler
