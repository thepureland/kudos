 ...
 *
 * 测试数据来源：`RoleIdByTenantIdAndRoleCodeCacheTest.sql`
 *
 * @author K
 * @author AI: Cursor
 * @since 1.0.0
...
class RoleIdByTenantIdAndRoleCodeCacheTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: RoleIdByTenantIdAndRoleCodeCache
    ...
    fun syncOnBatchDelete() {
        ...
        val authRole1 = AuthRole.Companion().apply {
            this.tenantId = tenantId
            this.code = roleCode1
        ...
        val authRole2 = AuthRole.Companion().apply {
            this.tenantId = tenantId
            this.code = roleCode2
