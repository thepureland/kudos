 ...
 *
 * 测试数据来源：`UserIdsByTenantIdAndGroupCodeCacheHandlerTest.sql`
 *
 * @author K
 * @author AI: Codex
 * @since 1.0.0
...
class UserIdsByTenantIdAndGroupCodeCacheHandlerTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: UserIdsByTenantIdAndGroupCodeCacheHandler
