-- auth_group: 每条 id 唯一，供 AuthGroupService 用例使用
merge into "auth_group" ("id", "code", "name", "tenant_id", "subsys_code", "remark", "active", "built_in", "create_user_id", "create_user_name") values
    ('9a4a2d1b-0000-0000-0000-000000000030', 'svc-group-test-1-r9KxqP1a', 'svc-group-test-1-name-r9KxqP1a', 'svc-tenant-group-test-1-r9KxqP1a', 'ams', 'from AuthGroupServiceTest', true, false, 'system', '系统'),
