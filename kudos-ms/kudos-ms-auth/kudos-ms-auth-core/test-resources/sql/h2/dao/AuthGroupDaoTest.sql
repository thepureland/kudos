-- auth_group: 每条 id 唯一，使用 auth-group-dao-test-* 前缀隔离
merge into "auth_group" ("id", "code", "name", "tenant_id", "subsys_code", "remark", "active", "built_in", "create_user_id", "create_user_name") values
    ('9a4a2d1b-0000-0000-0000-000000000020', 'auth-group-dao-test-1-8GkL2Mxy', 'auth-group-dao-test-1-name-8GkL2Mxy', 'auth-tenant-dao-test-1-8GkL2Mxy', 'ams', 'from AuthGroupDaoTest', true, false, 'system', '系统'),
