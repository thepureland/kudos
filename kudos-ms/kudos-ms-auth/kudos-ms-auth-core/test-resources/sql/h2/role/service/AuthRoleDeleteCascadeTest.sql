...
-- auth_role_scope: roleA 的自定义数据范围授权（org 维度；本表由 auth_role_org 泛化而来）
merge into "auth_role_scope" ("id", "role_id", "dimension", "scope_value", "create_user_id", "create_user_name") values
    ('3fae12cd-0000-0000-0000-0000000000f1', '3fae12cd-0000-0000-0000-0000000000a1', 'org', '3fae12cd-0000-0000-0000-0000000000f9', 'system', '系统');
