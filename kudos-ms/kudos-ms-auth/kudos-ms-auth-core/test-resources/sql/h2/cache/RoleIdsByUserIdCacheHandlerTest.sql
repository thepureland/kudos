-- user_account: 每条 id 唯一，供用户-角色链使用
...
merge into "auth_role" ("id", "code", "name", "tenant_id", "subsys_code", "remark", "active", "built_in", "create_user_id", "create_user_name", "update_user_id", "update_user_name") values
    ('88207878-1111-1111-1111-111111111111', 'ROLE_ADMIN', '系统管理员', 'tenant-001-Gv4Pb40w', 'ams', '系统管理员角色', true, true, 'system', '系统', null, null),
...
merge into "auth_role_user" ("id", "role_id", "user_id", "create_user_id", "create_user_name") values
    ('88207878-1111-1111-1111-111111111111', '88207878-1111-1111-1111-111111111111', '88207878-1111-1111-1111-111111111111', 'system', '系统'),
