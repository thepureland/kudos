-- user_account: 每条 id 唯一，供用户组-用户关联
...
merge into "auth_group" ("id", "code", "name", "tenant_id", "subsys_code", "remark", "active", "built_in", "create_user_id", "create_user_name", "update_user_id", "update_user_name") values
    ('6e90ce80-1111-1111-1111-111111111111', 'GROUP_ADMIN', '管理员组', 'tenant-001-twyuFAaV', 'ams', '管理员用户组', true, true, 'system', '系统', null, null),
...
-- auth_group_user: 用户组-用户关系
merge into "auth_group_user" ("id", "group_id", "user_id", "create_user_id", "create_user_name") values
    ('6e90ce80-1111-1111-1111-111111111111', '6e90ce80-1111-1111-1111-111111111111', '5e90ce80-1111-1111-1111-111111111111', 'system', '系统'),
