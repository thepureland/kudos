-- auth_group: 每条 id 唯一，(tenant_id, code) 供缓存 key 使用
merge into "auth_group" ("id", "code", "name", "tenant_id", "subsys_code", "remark", "active", "built_in", "create_user_id", "create_user_name", "update_user_id", "update_user_name") values
    ('7e2b8b93-1111-1111-1111-111111111111', 'GROUP_ADMIN', '管理员组', 'tenant-001-yoCqktm5', 'ams', '管理员用户组', true, true, 'system', '系统', null, null),
