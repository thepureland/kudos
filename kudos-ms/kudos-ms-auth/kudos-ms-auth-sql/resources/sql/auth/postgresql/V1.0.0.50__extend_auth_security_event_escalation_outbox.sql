...
ALTER TABLE "auth_security_event" ADD CONSTRAINT "ck_auth_security_event_escalation_level"
    CHECK ("escalation_level" BETWEEN 0 AND 10);
ALTER TABLE "auth_security_event" ADD CONSTRAINT "ck_auth_security_event_escalation_fields"
    CHECK (
