...
/**
 * Test for [AuthApiInternalAutoConfiguration].
 *
 * Only the pure, container-free contract is exercised here: [AuthApiInternalAutoConfiguration.getComponentName]
 ...
 * @since 1.0.0
 */
internal class AuthApiInternalAutoConfigurationTest {

    private val config = AuthApiInternalAutoConfiguration()
