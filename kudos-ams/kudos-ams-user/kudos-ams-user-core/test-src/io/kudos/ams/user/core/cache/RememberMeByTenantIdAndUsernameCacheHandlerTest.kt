 ...
 *
 * 测试数据来源：`RememberMeByTenantIdAndUsernameCacheHandlerTest.sql`
 *
 * @author K
 * @author AI: Codex
 * @since 1.0.0
...
class RememberMeByTenantIdAndUsernameCacheHandlerTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: RememberMeByTenantIdAndUsernameCacheHandler
