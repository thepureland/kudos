...
merge into "auth_user" ("id", "username", "tenant_id", "login_password", "supervisor_id", "remark", "active", "built_in", "create_user_id", "create_user_name")
    values ('1a14e2ae-0000-0000-0000-000000000078', 'svc-user-loglog-test-1-88Sexq53', 'svc-tenan-loglo-test-1-88Sexq53', 'encrypted-pwd-1-88Sexq53', '00000000-0000-0000-0000-000000000000', 'from AuthLogLoginServiceTest', true, false, 'system', '系统'),
           ('1a14e2ae-0000-0000-0000-000000000079', 'svc-user-loglog-test-2-88Sexq53', 'svc-tenan-loglo-test-1-88Sexq53', 'encrypted-pwd-2-88Sexq53', '00000000-0000-0000-0000-000000000000', 'from AuthLogLoginServiceTest', true, false, 'system', '系统'),
           ('1a14e2ae-0000-0000-0000-000000000080', 'svc-user-loglog-test-3-88Sexq53', 'svc-tenan-loglo-test-2-88Sexq53', 'encrypted-pwd-3-88Sexq53', '00000000-0000-0000-0000-000000000000', 'from AuthLogLoginServiceTest', true, false, 'system', '系统');

merge into "auth_log_login" ("id", "user_id", "username", "tenant_id", "login_time", "login_ip", "login_success", "failure_reason", "create_time")
    values ('1a14e2ae-0000-0000-0000-000000000070', '1a14e2ae-0000-0000-0000-000000000078', 'svc-user-loglog-test-1-88Sexq53', 'svc-tenan-loglo-test-1-88Sexq53', '2024-01-01 10:00:00', 192168001001, true, null, '2024-01-01 10:00:00'),
