...
merge into "user_account" ("id", "username", "tenant_id", "login_password", "supervisor_id", "remark", "active", "built_in", "create_user_id", "create_user_name")
    values ('1a14e2ae-0000-0000-0000-000000000078', 'svc-user-loglog-test-1-88Sexq53', 'svc-tenan-loglo-test-1-88Sexq53', 'encrypted-pwd-1-88Sexq53', '00000000-0000-0000-0000-000000000000', 'from UserLogLoginServiceTest', true, false, 'system', '系统'),
...
merge into "user_log_login" ("id", "user_id", "username", "tenant_id", "login_time", "login_ip", "login_success", "failure_reason", "create_time")
