-- 测试数据：UserOrgUserServiceTest
-- 使用唯一前缀 svc-orguser-test-* 和唯一UUID确保测试数据隔离
...
merge into "user_account" ("id", "username", "tenant_id", "login_password", "supervisor_id", "remark", "active", "built_in", "create_user_id", "create_user_name")
    values ('6cd22b48-0000-0000-0000-000000000060', 'svc-user-orgus-test-1-xYvfu9vP', 'svc-tenan-orgu-test-1-xYvfu9vP', 'encrypted-pwd-1-xYvfu9vP', '00000000-0000-0000-0000-000000000000', 'from UserOrgUserServiceTest', true, false, 'system', '系统'),
...
merge into "user_org" ("id", "name", "tenant_id", "org_type_dict_code", "sort_num", "remark", "active", "built_in", "create_user_id", "create_user_name")
    values ('6cd22b48-0000-0000-0000-000000000063', 'svc-org-orgus-test-1-xYvfu9vP', 'svc-tenan-orgu-test-1-xYvfu9vP', 'ORG_TYPE_TEST', 1, 'from UserOrgUserServiceTest', true, false, 'system', '系统'),
...
-- 创建已存在的机构-用户关系（用于测试exists和unbind）
