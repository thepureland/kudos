package io.kudos.ams.msg.common.vo.send
 ...
 * @since 1.0.0
 */
data class MsgSendSearchPayload (

    //region your codes 1

    override var returnEntityClass: KClass<*>? = MsgSendRecord::class,
...
//endregion your codes 2
    ...
    constructor() : this(MsgSendRecord::class)
