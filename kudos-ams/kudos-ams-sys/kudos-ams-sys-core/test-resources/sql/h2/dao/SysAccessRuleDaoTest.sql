...
merge into "sys_sub_system" ("code", "name", "system_code", "remark", "active", "built_in")
    values ('svc-subsys-ar-dao-test-1', 'svc-subsys-accessrule-dao-test-1-name', 'svc-system-ar-dao-test-1', 'from SysAccessRuleDaoTest', true, false);

merge into "sys_access_rule" ("id", "tenant_id", "sub_system_code", "system_code", "rule_type_dict_code", "remark", "active", "built_in")
    values ('40000000-0000-0000-0000-000000000151', '40000000-0000-0000-0000-000000000150', 'svc-subsys-ar-dao-test-1', 'svc-system-ar-dao-test-1', 'RULE_TYPE_WHITELIST', 'from SysAccessRuleDaoTest', true, false),
           ('40000000-0000-0000-0000-000000000152', '40000000-0000-0000-0000-000000000150', null, 'svc-system-ar-dao-test-1', 'RULE_TYPE_BLACKLIST', 'from SysAccessRuleDaoTest', true, false);
