...
merge into "sys_sub_system" ("code", "name", "system_code", "remark", "active", "built_in")
    values ('svc-subsys-arip-test-1', 'svc-subsys-arip-test-1-name', 'svc-system-arip-test-1', 'from SysAccessRuleIpServiceTest', true, false);

merge into "sys_access_rule" ("id", "tenant_id", "sub_system_code", "system_code", "rule_type_dict_code", "remark", "active", "built_in")
    values ('20000000-0000-0000-0000-000000000034', '20000000-0000-0000-0000-000000000034', 'svc-subsys-arip-test-1', 'svc-system-arip-test-1', '1', 'from SysAccessRuleIpServiceTest', true, false);
