...
import io.kudos.ams.sys.core.dao.SysI18nDao
 ...
 */
@Component
open class I18NByLocaleAndTypeAndAmsCodeCacheHandler : AbstractCacheHandler<Map<String, String>>() {
    ...
    override fun doReload(key: String): Map<String, String>? {
        ...
        return getSelf<I18NByLocaleAndTypeAndAmsCodeCacheHandler>().getI18ns(parts[0], parts[1], parts[2])
    }
    ...
    open fun syncOnInsert(any: Any, id: String) {
        if (CacheKit.isCacheActive(CACHE_NAME)) {
            ...
            if (CacheKit.isWriteInTime(CACHE_NAME)) {
                getSelf<I18NByLocaleAndTypeAndAmsCodeCacheHandler>().getI18ns(
