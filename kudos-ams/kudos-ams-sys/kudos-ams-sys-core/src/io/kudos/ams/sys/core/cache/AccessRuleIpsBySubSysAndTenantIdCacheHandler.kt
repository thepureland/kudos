 ...
 */
@Component
open class AccessRuleIpsBySubSysAndTenantIdCacheHandler : AbstractCacheHandler<List<SysAccessRuleIpCacheItem>>() {
    ...
    override fun doReload(key: String): List<SysAccessRuleIpCacheItem> {
        ...
        return getSelf<AccessRuleIpsBySubSysAndTenantIdCacheHandler>().getAccessRuleIps(parts[0], parts[1])
    }
