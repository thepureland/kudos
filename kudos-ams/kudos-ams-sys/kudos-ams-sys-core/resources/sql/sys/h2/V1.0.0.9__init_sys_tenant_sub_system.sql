...
create unique index if not exists "uq_sys_tenant_sub_system"
    on "sys_tenant_sub_system" ("tenant_id", "sub_system_code", "system_code");
...
--
-- alter table "sys_tenant_sub_system"
--     add constraint "fk_sys_tenant_sub_system_system"
...
comment on column "sys_tenant_sub_system"."system_code" is '系统编码';
