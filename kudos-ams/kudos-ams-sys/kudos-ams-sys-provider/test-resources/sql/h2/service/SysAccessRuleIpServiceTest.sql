...
merge into "sys_portal" ("code", "name", "remark", "active", "built_in")
    values ('svc-portal-arip-test-1', 'svc-portal-arip-test-1-name', 'from SysAccessRuleIpServiceTest', true, false);

merge into "sys_sub_system" ("code", "name", "portal_code", "remark", "active", "built_in")
    values ('svc-subsys-arip-test-1', 'svc-subsys-arip-test-1-name', 'svc-portal-arip-test-1', 'from SysAccessRuleIpServiceTest', true, false);

merge into "sys_access_rule" ("id", "tenant_id", "sub_system_code", "portal_code", "rule_type_dict_code", "remark", "active", "built_in")
    values ('20000000-0000-0000-0000-000000000034', '20000000-0000-0000-0000-000000000034', 'svc-subsys-arip-test-1', 'svc-portal-arip-test-1', '1', 'from SysAccessRuleIpServiceTest', true, false);
