...
import io.kudos.ams.sys.provider.service.iservice.ISysTenantLanguageService
 ...
 *
 * 测试数据来源：`V1.0.0.39__SysTenantLanguageServiceTest.sql`
 *
 * @author K
 * @author AI: Cursor
 * @since 1.0.0
...
class SysTenantLanguageServiceTest : CacheHandlerTestBase() {
