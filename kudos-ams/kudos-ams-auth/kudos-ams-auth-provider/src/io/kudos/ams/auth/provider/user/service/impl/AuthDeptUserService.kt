package io.kudos.ams.auth.provider.user.service.impl

import io.kudos.ability.data.rdb.ktorm.service.BaseCrudService
import io.kudos.ams.auth.provider.user.cache.DeptIdsByUserIdCacheHandler
import io.kudos.ams.auth.provider.user.cache.UserIdsByDeptIdCacheHandler
import io.kudos.ams.auth.provider.user.dao.AuthDeptUserDao
import io.kudos.ams.auth.provider.user.model.po.AuthDeptUser
import io.kudos.ams.auth.provider.user.service.iservice.IAuthDeptUserService
