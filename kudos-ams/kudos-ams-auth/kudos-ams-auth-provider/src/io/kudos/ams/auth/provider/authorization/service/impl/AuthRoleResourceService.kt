...
import io.kudos.ams.auth.provider.authorization.cache.ResourceIdsByRoleIdCacheHandler
...
import io.kudos.ams.auth.provider.authorization.service.iservice.IAuthRoleResourceService
...
//endregion your codes 1
    ...
    override fun batchBind(roleId: String, resourceIds: Collection<String>): Int {
        ...
        roleUsers.map { it.userId }.distinct().forEach { userId ->
