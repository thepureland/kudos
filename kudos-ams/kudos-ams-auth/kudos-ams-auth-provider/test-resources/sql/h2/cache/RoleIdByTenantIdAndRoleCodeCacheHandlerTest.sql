-- 测试数据 for RoleIdByTenantIdAndRoleCodeCacheHandler
merge into "auth_role" ("id", "code", "name", "tenant_id", "subsys_code", "remark", "active", "built_in", "create_user_id", "create_user_name", "update_user_id", "update_user_name")
    values ('6e2b8b93-1111-1111-1111-111111111111', 'ROLE_ADMIN', '系统管理员', 'tenant-001-yoCqktm5', 'ams', '系统管理员角色', true, true, 'system', '系统', null, null),
