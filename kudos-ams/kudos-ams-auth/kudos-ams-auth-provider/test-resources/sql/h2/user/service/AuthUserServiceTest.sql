...
merge into "auth_role" ("id", "code", "name", "tenant_id", "subsys_code", "remark", "active", "built_in", "create_user_id", "create_user_name")
    values ('a970f8c0-0000-0000-0000-000000000022', 'svc-role-user-test-1-3iZR7Pv6', 'svc-rol-use-tes-1-name-3iZR7Pv6', 'svc-tenant-user-test-1-3iZR7Pv6', 'ams', 'from AuthUserServiceTest', true, false, 'system', '系统');

-- 创建角色-用户关系（用于测试 getUsersByRoleCode）
merge into "auth_role_user" ("id", "role_id", "user_id", "create_user_id", "create_user_name")
    values ('a970f8c0-0000-0000-0000-000000000023', 'a970f8c0-0000-0000-0000-000000000022', 'a970f8c0-0000-0000-0000-000000000016', 'system', '系统'),
           ('a970f8c0-0000-0000-0000-000000000024', 'a970f8c0-0000-0000-0000-000000000022', 'a970f8c0-0000-0000-0000-000000000017', 'system', '系统');
