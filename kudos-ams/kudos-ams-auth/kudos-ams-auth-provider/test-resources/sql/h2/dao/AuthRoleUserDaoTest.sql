...
merge into "user_account" ("id", "username", "tenant_id", "login_password", "supervisor_id", "remark", "active", "built_in", "create_user_id", "create_user_name")
    values ('42d84639-0000-0000-0000-000000000050', 'user-account-rol-dao-tes-1-kRWTnffD', 'auth-tena-rol-dao-tes-1-kRWTnffD', 'encrypted-pwd-1-kRWTnffD', '00000000-0000-0000-0000-000000000000', 'from AuthRoleUserDaoTest', true, false, 'system', '系统'),
           ('42d84639-0000-0000-0000-000000000051', 'user-account-rol-dao-tes-2-kRWTnffD', 'auth-tena-rol-dao-tes-1-kRWTnffD', 'encrypted-pwd-2-kRWTnffD', '00000000-0000-0000-0000-000000000000', 'from AuthRoleUserDaoTest', true, false, 'system', '系统');
