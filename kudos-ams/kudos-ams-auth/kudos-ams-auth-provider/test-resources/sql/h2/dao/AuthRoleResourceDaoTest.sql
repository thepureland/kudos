...
merge into "auth_role" ("id", "code", "name", "tenant_id", "subsys_code", "remark", "active", "built_in", "create_user_id", "create_user_name")
    values ('49748162-0000-0000-0000-000000000060', 'auth-role-rol-dao-tes-1-mVUk8tb9', 'auth-rol-ro-da-te-1-nam-mVUk8tb9', 'auth-tena-rol-dao-tes-1-mVUk8tb9', 'ams', 'from AuthRoleResourceDaoTest', true, false, 'system', '系统'),
...
merge into "sys_portal" ("code", "name", "remark", "active", "built_in")
    values ('auth-port-rol-dao-tes-1-mVUk8tb9', 'auth-por-ro-da-te-1-nam-mVUk8tb9', 'from AuthRoleResourceDaoTest', true, false);

merge into "sys_sub_system" ("code", "name", "portal_code", "remark", "active", "built_in")
    values ('auth-subs-rol-dao-tes-1-mVUk8tb9', 'auth-sub-ro-da-te-1-nam-mVUk8tb9', 'auth-port-rol-dao-tes-1-mVUk8tb9', 'from AuthRoleResourceDaoTest', true, false);
...
merge into "sys_resource" ("id", "name", "url", "resource_type_dict_code", "parent_id", "order_num", "icon", "sub_system_code", "remark", "active", "built_in")
    values ('49748162-0000-0000-0000-000000000062', 'sys-reso-role-dao-tes-1-mVUk8tb9', '/sys-reso-rol-dao-tes-1-mVUk8tb9', 'M', null, 1, null, 'auth-subs-rol-dao-tes-1-mVUk8tb9', 'from AuthRoleResourceDaoTest', true, false),
...
merge into "auth_role_resource" ("id", "role_id", "resource_id", "create_user_id", "create_user_name")
    values ('49748162-0000-0000-0000-000000000064', '49748162-0000-0000-0000-000000000060', '49748162-0000-0000-0000-000000000062', 'system', '系统'),
