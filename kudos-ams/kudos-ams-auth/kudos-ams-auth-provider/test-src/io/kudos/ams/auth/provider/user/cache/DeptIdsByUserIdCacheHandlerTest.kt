...
import io.kudos.ams.auth.provider.user.dao.AuthDeptUserDao
...
class DeptIdsByUserIdCacheHandlerTest : RdbAndRedisCacheTestBase() {
    ...
    fun getDeptIds() {
        ...
        assertTrue(deptIds1.contains("81cea00f-1111-1111-1111-111111111111"), "应该包含技术部的部门ID，实际返回：${deptIds1}")
        ...
        assertTrue(deptIds3.contains("81cea00f-1111-1111-1111-111111111111"), "应该包含技术部的部门ID")
        assertTrue(deptIds3.contains("81cea00f-2222-2222-2222-222222222222"), "应该包含产品部的部门ID")
    ...
    fun syncOnDeptUserChange() {
        ...
        val deptId = "81cea00f-2222-2222-2222-222222222222"
    ...
    fun syncOnBatchDeptUserChange() {
        ...
        val deptId1 = "81cea00f-1111-1111-1111-111111111111"
        val deptId2 = "81cea00f-2222-2222-2222-222222222222"
    ...
    fun syncOnUserDelete() {
        val userId = "81cea00f-3333-3333-3333-333333333333"
        val deptId = "81cea00f-1111-1111-1111-111111111111"
