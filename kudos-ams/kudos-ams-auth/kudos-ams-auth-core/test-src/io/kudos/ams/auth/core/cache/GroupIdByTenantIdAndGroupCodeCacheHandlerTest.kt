 ...
 *
 * 测试数据来源：`GroupIdByTenantIdAndGroupCodeCacheHandlerTest.sql`
 *
 * @author K
 * @author AI: Codex
 * @since 1.0.0
...
class GroupIdByTenantIdAndGroupCodeCacheHandlerTest : RdbAndRedisCacheTestBase() {

    @Resource
    private lateinit var cacheHandler: GroupIdByTenantIdAndGroupCodeCacheHandler
