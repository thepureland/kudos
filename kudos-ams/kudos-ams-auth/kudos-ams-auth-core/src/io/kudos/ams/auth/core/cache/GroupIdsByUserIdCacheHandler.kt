 ...
 */
@Component
open class GroupIdsByUserIdCacheHandler : AbstractCacheHandler<List<String>>() {
    ...
    override fun doReload(key: String): List<String> = getSelf<GroupIdsByUserIdCacheHandler>().getGroupIds(key)
    ...
    open fun syncOnGroupUserChange(userId: String) {
        if (CacheKit.isCacheActive(CACHE_NAME)) {
            ...
            if (CacheKit.isWriteInTime(CACHE_NAME)) {
                getSelf<GroupIdsByUserIdCacheHandler>().getGroupIds(userId)
            }
