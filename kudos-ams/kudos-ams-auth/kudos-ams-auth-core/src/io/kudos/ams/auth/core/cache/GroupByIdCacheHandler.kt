...
import io.kudos.ams.auth.common.vo.group.AuthGroupCacheItem
 ...
 */
@Component
open class GroupByIdCacheHandler : AbstractByIdCacheHandler<String, AuthGroupCacheItem, AuthGroupDao>() {
    ...
    override fun doReload(key: String): AuthGroupCacheItem? {
        return getSelf<GroupByIdCacheHandler>().getGroupById(key)
    }
