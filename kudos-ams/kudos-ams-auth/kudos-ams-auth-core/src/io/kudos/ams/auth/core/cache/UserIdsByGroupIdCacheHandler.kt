 ...
 */
@Component
open class UserIdsByGroupIdCacheHandler : AbstractCacheHandler<List<String>>() {
    ...
    override fun doReload(key: String): List<String> = getSelf<UserIdsByGroupIdCacheHandler>().getUserIds(key)
    ...
    open fun syncOnGroupUserChange(groupId: String) {
        if (CacheKit.isCacheActive(CACHE_NAME)) {
            ...
            if (CacheKit.isWriteInTime(CACHE_NAME)) {
                getSelf<UserIdsByGroupIdCacheHandler>().getUserIds(groupId)
            }
