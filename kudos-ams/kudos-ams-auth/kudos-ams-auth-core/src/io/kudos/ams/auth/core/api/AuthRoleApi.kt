package io.kudos.ams.auth.core.api
...
//endregion your codes 1
    ...
    @Autowired
    private lateinit var roleByIdCacheHandler: io.kudos.ams.auth.core.cache.RoleByIdCacheHandler

    @Autowired
    private lateinit var roleIdByTenantIdAndRoleCodeCacheHandler: io.kudos.ams.auth.core.cache.RoleIdByTenantIdAndRoleCodeCacheHandler

    @Autowired
    private lateinit var authRoleService: io.kudos.ams.auth.core.service.iservice.IAuthRoleService

    @Autowired
    private lateinit var userIdsByTenantIdAndRoleCodeCacheHandler: io.kudos.ams.auth.core.cache.UserIdsByTenantIdAndRoleCodeCacheHandler
