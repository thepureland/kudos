...
open class ResourceIdsByRoleIdCacheHandler : AbstractCacheHandler<List<String>>() {
    ...
    override fun doReload(key: String): List<String> = getSelf<ResourceIdsByRoleIdCacheHandler>().getResourceIds(key)
    ...
    open fun syncOnRoleResourceChange(roleId: String) {
        if (CacheKit.isCacheActive(CACHE_NAME)) {
            ...
            if (CacheKit.isWriteInTime(CACHE_NAME)) {
                getSelf<ResourceIdsByRoleIdCacheHandler>().getResourceIds(roleId)
            }
