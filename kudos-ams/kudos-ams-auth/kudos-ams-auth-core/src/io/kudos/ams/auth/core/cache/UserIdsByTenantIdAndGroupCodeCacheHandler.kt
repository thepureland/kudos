 ...
 */
@Component
open class UserIdsByTenantIdAndGroupCodeCacheHandler : AbstractCacheHandler<List<String>>() {
    ...
    override fun doReload(key: String): List<String> {
        ...
        return getSelf<UserIdsByTenantIdAndGroupCodeCacheHandler>().getUserIds(
    ...
    open fun syncOnGroupUserInsert(tenantId: String, groupCode: String) {
        if (CacheKit.isCacheActive(CACHE_NAME)) {
            ...
            if (CacheKit.isWriteInTime(CACHE_NAME)) {
                getSelf<UserIdsByTenantIdAndGroupCodeCacheHandler>().getUserIds(tenantId, groupCode)
            }
