 ...
 */
@Component
open class UserIdsByTenantIdAndRoleCodeCacheHandler : AbstractCacheHandler<List<String>>() {
    ...
    override fun doReload(key: String): List<String> {
        ...
        return getSelf<UserIdsByTenantIdAndRoleCodeCacheHandler>().getUserIds(
    ...
    open fun syncOnRoleUserInsert(tenantId: String, roleCode: String) {
        if (CacheKit.isCacheActive(CACHE_NAME)) {
            ...
            if (CacheKit.isWriteInTime(CACHE_NAME)) {
                getSelf<UserIdsByTenantIdAndRoleCodeCacheHandler>().getUserIds(tenantId, roleCode)
            }
