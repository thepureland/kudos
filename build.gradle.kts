...
//            mavenBom("com.alibaba.cloud:spring-cloud-alibaba-dependencies:${Version.ALIBABA_CLOUD}")
        ...
        dependencies {
            ...
            dependency("org.soul:soul-ability-distributed-client:${Version.SOUL}")
            dependency("org.soul:soul-ability-doc-swagger:${Version.SOUL}")
            dependency("org.soul:soul-ability-upload-common:${Version.SOUL}")
            dependency("org.soul:soul-ability-upload-local:${Version.SOUL}")
            dependency("org.soul:soul-ability-upload-minio:${Version.SOUL}")
            dependency("org.soul:soul-ability-upload-oss:${Version.SOUL}")
            dependency("org.soul:soul-ability-engine-workflow:${Version.SOUL}")
            dependency("org.soul:soul-ability-logaudit-common:${Version.SOUL}")
            dependency("org.soul:soul-ability-logaudit-mongo:${Version.SOUL}")
            dependency("org.soul:soul-ability-logaudit-mq:${Version.SOUL}")
            dependency("org.soul:soul-ability-logaudit-rdb:${Version.SOUL}")
            dependency("org.soul:soul-ability-msg-common:${Version.SOUL}")
            dependency("org.soul:soul-ability-msg-email:${Version.SOUL}")
            dependency("org.soul:soul-ability-msg-sms-aliyun:${Version.SOUL}")
            dependency("org.soul:soul-ability-msg-sms-aws:${Version.SOUL}")
            dependency("org.soul:soul-ability-notify-common:${Version.SOUL}")
            dependency("org.soul:soul-ability-notify-mq:${Version.SOUL}")
            dependency("org.soul:soul-ability-notify-rdb:${Version.SOUL}")
            ...
            dependency("org.soul:soul-ability-stream-common:${Version.SOUL}")
            dependency("org.soul:soul-ability-stream-kafka:${Version.SOUL}")
            dependency("org.soul:soul-ability-stream-rabbit:${Version.SOUL}")
            dependency("org.soul:soul-ability-stream-rocketmq:${Version.SOUL}")
