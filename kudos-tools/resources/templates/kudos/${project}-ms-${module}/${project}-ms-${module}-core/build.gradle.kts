dependencies {
<#if project == "kudos">
    api(project(":kudos-ms:kudos-ms-${module}:kudos-ms-${module}-sql"))
    api(project(":kudos-ms:kudos-ms-${module}:kudos-ms-${module}-common"))
...
<#else>
    api(project(":${project}-ms-${module}:${project}-ms-${module}-sql"))
    api(project(":${project}-ms-${module}:${project}-ms-${module}-common"))
...
<#else>
    api("io.kudos:kudos-ability-cache-local-caffeine")
