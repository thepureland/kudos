package ${packagePrefix}.${moduleName}.api.view.controller
...
import io.kudos.ability.web.springmvc.BaseCrudController
<#assign superController = "BaseCrudController">
</#if>
<#if table.type.name() == "VIEW">
import io.kudos.ability.web.springmvc.BaseReadOnlyController
